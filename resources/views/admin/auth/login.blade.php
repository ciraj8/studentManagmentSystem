    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark">
            <div id="loginform">
                ...
                <img src="{{asset('admin-panel/assets/images/logo1.png')}}"   class="rounded-circle" alt="user">
                </div>
                <!-- Form -->
                    ...
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    <button class="btn btn-warning" id="to-recover" style="border-radius:15px;" type="button"><i class="fa fa-lock m-r-5"></i> Lost password?</button>
                                    <button class="btn btn-success float-right" style="border-radius:15px;" type="submit">Login</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="recoverform">
                <div class="text-center">
                    <span class="text-white">Enter your e-mail address below and we will guide you  how to recover a password.</span>
                </div>
